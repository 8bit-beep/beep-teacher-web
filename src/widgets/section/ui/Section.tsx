...
const Section = ({
  ...
  return (
    <section className="w-full min-h-0 flex-1 bg-static-white p-5 xl:p-0 xl:pt-5  flex flex-col gap-5 rounded-large xl:rounded-b-none shadow-modal overflow-hidden">
